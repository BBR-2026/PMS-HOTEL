...
export default function UniversHebergement() {
  return (
    <UniversPage
      ...
      offers={[
        {
          testId: "chambres-exclusives",
          title: "Chambres Exclusives",
          description:
            "Ouvertes sur le jardin tropical. La porte d'entrée vers l'univers BBr.",
          features: [
          ...
          cta: { to: "/booking/hebergement?tier=superieure", label: "Réserver" },
        },
        {
          testId: "suites-jardin",
          title: "Suites Jardin",
          description:
            "Coin salon, baignoire balnéo, et jardin privatif tropical.",
          features: [
          ...
          cta: { to: "/booking/hebergement?tier=suite_jardin", label: "Réserver" },
          badge: "Populaire",
        },
        {
          testId: "suites-lagune",
          title: "Suites Lagune",
          description:
            "Face à l'eau. Piscine privée, terrasse panoramique, expérience absolue.",
          features: [
            "Piscine privée à débordement",
            "Terrasse face lagune",
            "Champagne d'accueil",
          ...
          cta: { to: "/booking/hebergement?tier=suite_lagune", label: "Réserver" },
          badge: "Signature",
        },
      ]}
      highlights={[
