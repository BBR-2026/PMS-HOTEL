...
export default function StaffClients() {
  ...
  return (
    <div className="p-8 md:p-10 max-w-7xl mx-auto" data-testid="staff-clients">
      <div className="flex items-center justify-between mb-2">
        <h1 className="font-display-serif text-3xl md:text-4xl text-[#0A0A0A]">Clients</h1>
        <button
          onClick={downloadCsv}
      ...
      <div className="bg-white border border-[#0A0A0A]/8">
        ...
        {filtered.map((c) => (
          ...
          >
            ...
            <div className="col-span-3 text-sm text-[#0A0A0A]/70">
              <div>{c.email}</div>
            ...
            <div className="col-span-2 text-sm font-medium text-[#0A0A0A]">{formatXOF(c.total_spent || 0)}</div>
            <div className="col-span-2 text-sm text-[#0A0A0A]/70">{c.last_visit || "—"}</div>
          </button>
        ))}
      </div>
